...
class main:
    ...
    def cur(self):
        ...
        self.develop = Label(self.fm3, text='Developed By - Ishika', bg='#fff', fg='#d7837f',
        ...
        self.bt1 = Button(self.fm3, text='  Add Books', fg='#fff', bg='#581845', font=('Candara', 15, 'bold'),
                          width=170, height=0, bd=7, relief='flat', command=self.addbook, cursor='hand2',
        ...
        class temp(main):
            def book(self):
                ...
                self.bt = Button(self.fm1, text='SUBMIT', width=8, fg='white', bg='#ff6690',
                                 font=('Canara', 12, 'bold'), bd=3, relief='flat', command=self.submit1,
                                 activebackground='black', activeforeground='#ff6690')
        ...
        class test(main):
            ...
            def issue(self):
                ...
                self.bt = Button(self.fc, text='SUBMIT', width=8, bg='#00203f', fg='#adefd1',
                                 font=('Canara', 12, 'bold'), bd=5, relief='flat', command=self.check,
                                 activeforeground='#00203f', activebackground='#adefd1')
            ...
            def data(self):
                ...
                if self.value != None:
                    if (self.flag != 1):
                        ...
                        self.lbn = Label(self.boot, text=self.value[2], bg='#ffe8ec', fg='black',
                                         font=('Calibri', 12, 'bold'))

                        self.lbn.place(x=120, y=60)
                        self.lb = Label(self.boot, text='Edition:', bg='#ffe8ec', fg='black',
                                        font=('Calibri', 12, 'bold'))

                        self.lb.place(x=30, y=90)
                        self.lbn = Label(self.boot, text=self.value[3], bg='#ffe8ec', fg='black',
                                         font=('Calibri', 12, 'bold'))
                        self.lbn.place(x=120, y=90)

                        self.label = Label(self.fr, text='ADD MORE BOOKS ', bg='#ffe8ec', fg='black',
                                           font=('times new romman', 11, 'bold'))
                        ...
                        btn1 = Button(self.boot, text="CONFIRM DATE", command=self.get_data, bg='#343148',
                                      font=('Canara', 11, 'bold'), fg='#d7c49e', activebackground='black',
                                      activeforeground='#d7c49e', relief='flat')
            ...
            def issued(self):
                ...
                comm.execute("UPDATE Students SET FromDate='" + str(self.x) + "', ToDate='" + str(
                    self.datecon) + "' , SubmitDate='' WHERE ERP='" + self.b + "'")
                dbstudents.commit()
    ...
    def edit(self):
        class editing(main):
            def edbooks(self):
                ...
                self.lab = Label(self.ed, text='EDIT BOOK DETAILS', bg='#1c1c1b', fg='#ce4a7e',
                                 font=('Calibri', 12, 'bold'))
                ...
                self.backbt = Button(self.ffm, width=60, bg='#ffe8ec', activebackground='#ffe8ec', bd=0, relief='flat',
                                     command=self.cur)
            ...
            def searchedit(self):
                ...
                if self.val != None:
                    ...
                    self.labid = Label(self.edcat, bg='#ffe8ec', fg='black', text='Book ID:',
                                       font=('Calibri', 12, 'bold'))

                    self.labid.place(x=30, y=60)
                    self.labti = Label(self.edcat, bg='#ffe8ec', fg='black', text='Title:',
                                       font=('Calibri', 12, 'bold'))

                    self.labti.place(x=30, y=100)
                    self.labaut = Label(self.edcat, bg='#ffe8ec', fg='black', text='Author:',
                                        font=('Calibri', 12, 'bold'))

                    self.labaut.place(x=30, y=140)
                    self.labed = Label(self.edcat, bg='#ffe8ec', fg='black', text='Edition:',
                                       font=('Calibri', 12, 'bold'))

                    self.labed.place(x=30, y=180)
                    self.labpr = Label(self.edcat, bg='#ffe8ec', fg='black', text='Price:',
                                       font=('Calibri', 12, 'bold'))
    ...
    def returnbook(self):
        class retu(main):
            def __init__(self):
                ...
                self.label8 = Label(self.f1, text='ERP ID', bg='#ffe8ec', fg='black',
                                    font=('Times New Roman', 11, 'bold'))
                ...
                self.backbt = Button(self.frame, width=60, bg='#ffe8ec', activebackground='#ffe8ec', bd=0,
                        ...
                        if self.var != None:
                            ...
                            if chm <= 0:
                                ...
                                self.tombtn = Button(self.tom, text='SUBMIT', background='#581845', foreground='white',
                                                     font=('Calibri', 12, 'bold'), width=8, activebackground='black',
                                                     activeforeground='#581845', relief='flat', command=self.retsucc)
    ...
    def delete(self):
        class dele(main):
            def deletebooks(self):
                ...
                self.backbt = Button(self.ff, width=60, bg='#ffe8ec', activebackground='#ffe8ec', bd=0, relief='flat',
                                     command=self.cur)
                self.backbt.place(x=0, y=0)
                self.log = PhotoImage(file='filename.png')
                self.backbt.config(image=self.log, compound=LEFT)
    ...
    def search(self):
        class demt(main):
            def delmdata(self):
                ...
                self.backbt = Button(self.fc, width=60, bg='#ffe8ec', activebackground='#ffe8ec', bd=0, relief='flat',
                                     command=self.cur)
                self.backbt.place(x=0, y=0)
                self.log = PhotoImage(file='filename.png')
                self.backbt.config(image=self.log, compound=LEFT)
    ...
    def show(self):
        class test(main):
            def __init__(self):
                ...
                self.backbt = Button(self.fc, width=30, bg='#ffe8ec', activebackground='#ffe8ec', bd=0, relief='flat',
                                     command=self.cur)
                self.backbt.place(x=0, y=0)
                self.log = PhotoImage(file='filename.png')
                self.backbt.config(image=self.log, compound=LEFT)
    ...
    def code(self):
        ...
        self.photo = PhotoImage(file=r"C:\Users\HP\PycharmProjects\freelance1\backbtn1.png")
    ...
    def mouseClick(self, event):
        ...
        self.btn1 = Button(self.rog, text='SUBMIT', fg='#606060', bg='#d6ed17', width=8, font=('Calibri', 12, 'bold'),
                           activebackground='black', activeforeground='#d6ed17', bd=3, relief='flat', cursor='hand2',
